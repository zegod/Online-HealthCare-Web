...
<tr>
<td>Name</td> <td><input type=text style="width:240;height=60"></td>
</tr>
<tr>
<td> Password </td> <td><input type=password style="width:240;height=40"></td> 
</tr>
</table>
<br> <br> <center>
<input type=submit value=LOGIN style="width:100;height=60;background-color:teal;color:white"> </center>
</center>
